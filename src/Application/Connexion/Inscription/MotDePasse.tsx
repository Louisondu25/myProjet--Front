...
export const Password = () => {
  return (
    <div className="flex flex-col justify-center items-center h-screen">
      ...
      <input type="email" placeholder="Saisissez votre Mot de passe" className="w-60 p-1 outline outline-1 outline-gray-400 focus:outline-gray-500 focus:ring-1 focus:ring-gray-500 rounded-md mt-6" />
      <div className="flex items-center mt-3">
      </div>
      <NavLink to={"/"}>
      <button className="w-60 p-2 mb-4 bg-blue-600 rounded-md px-6 py-2 text-white">Continuer</button>
      </NavLink>
