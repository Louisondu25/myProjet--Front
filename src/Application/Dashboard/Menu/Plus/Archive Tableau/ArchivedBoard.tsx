...
export const ArchivedBoard = () => {
  ...
  <div className="w-full h-screen flex flex-col items-center bg-gradient-to-b to-blue-500 from-cyan-500 to-white p-8">
    ...
    <div className="max-w-full mx-auto"> 
      ...
      <div>
        <button className="flex items-center gap-20 mb-3"><img src="https://picsum.photos/200/300?random=40" alt="Desert" className="w-20 h-20 object-cover rounded-md" />
      ...
      <div >
        <button className="flex items-center gap-20 mb-3">
